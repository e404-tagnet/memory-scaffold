...
# Run via cron: */5 * * * * /home/e404/Dropbox/9-PROJECTS/seshat/src/fs-guardian.sh
# Or manually when needed.

set -euo pipefail

SESHAT_ROOT="${HOME}/Dropbox/9-PROJECTS/seshat"
...
home = str(Path.home())
root = Path(home) / "Dropbox/9-PROJECTS/seshat"
